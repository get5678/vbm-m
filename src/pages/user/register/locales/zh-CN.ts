export default {
  ...
  'user-register.register.register.admin': '管理员注册',
  'user-register.register.register.user': '学员注册',
  'user-register.confirm-phone.required': '请输入手机号',
  'user-register.userName.required': '请输入用户名',
  'user-register.userSex.required': '请选择性别',
