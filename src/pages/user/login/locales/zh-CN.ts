export default {
  ...
  'user-login.login.message-invalid-admin': '登陆错误',
  'user-login.login.tab-login-admin': '管理员登录',
  'user-login.login.tab-login-user': '学员登录',
  ...
  'user-login.login.signup.admin': '管理员注册',
  'user-login.login.signup.user':'学员注册',
